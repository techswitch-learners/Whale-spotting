...
<div className="container">
  ...
  <div className="card-body">
    ...
    <p className="card-text">{ConservationData.Pollution.text}
</p>
    <a href={ConservationData.Pollution.siteLink} className="btn btn-primary">Read more</a>
  </div>
</div>
    </div>
        <div className="col-sm">
  ...
  <div className="card-body">
    ...
    <a href={ConservationData.Nets.siteLink} className="btn btn-primary">Read more</a>
  </div>
    </div>
    </div>
    <div className="col-sm">
  ...
  <div className="card-body">
    ...
    <a href={ConservationData.Whaling.siteLink} className="btn btn-primary">Read more</a>
  </div>
    </div>
    </div>
    <div className="col-sm">
    <div className="card">
  <img src={ConservationData.Captivity.imgSrc} className="card-img-top" alt="..."/>
  <div className="card-body">
    <h5 className="card-title">Captivity</h5>
    <p className="card-text">{ConservationData.Captivity.text}</p>
    <a href={ConservationData.Captivity.siteLink} className="btn btn-primary">Read more</a>
  </div>
    </div>
  </div>
  </div>
  </div>
  <p className="border border-dark">You can help immediately by donating to marine-life charities or by adopting a whale! To make a donation to SEA LIFE Trust, please click <a href="https://www.sealifetrust.org/en/"> here</a>. To adopt a marine animal, click <a href="https://www.pacificwhale.org/you-can-help/adopt-marine-animal/"> here</a>.
</p>
  </div>
    );
}
